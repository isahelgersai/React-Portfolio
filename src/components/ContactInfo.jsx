    ...
    <div class='grid col-span-1 md:flex items-center justify-center mt-20 font-inter'>
      <div class='md:flex items-center mb-4'>
        <div class='flex items-center md:mr-8 mb-4 md:mb-0'>
          ...
          <p className='text-stone-100'>isahelgersai@gmail.com</p>
        </div>

        <div class='md:flex items-center'>
          <div class='flex items-center md:mr-7'>
            <svg viewBox='0 0 24 24' className='w-7 h-7 mr-1 text-teal-500 fill-current'>
              <path d='M17 19H7V5h10m0-4H7c-1.11 0-2 .89-2 2v18a2 2 0 002 2h10a2 2 0 002-2V3a2 2 0 00-2-2z' />
            </svg>
            <p className='text-stone-100'>+57 3219007635 </p>
          </div>
        </div>
      </div>
    </div>
